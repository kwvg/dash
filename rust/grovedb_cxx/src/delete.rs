...
///
/// Returns `true` if the subtree was cleared, `false` if clearing was
/// skipped (e.g. the subtree contains child subtrees and the default
/// options prohibit clearing those).

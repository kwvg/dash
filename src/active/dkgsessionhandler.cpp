...
namespace llmq {
ActiveDKGSessionHandler::ActiveDKGSessionHandler(CBLSWorker& bls_worker, CDeterministicMNManager& dmnman, CMasternodeMetaMan& mn_metaman,
                                                 ...
                                                 const CSporkManager& sporkman, const Consensus::LLMQParams& llmq_params,
                                                 bool quorums_watch, int quorums_idx) :
    llmq::CDKGSessionHandler(bls_worker, dmnman, dkgdbgman, qdkgsman, mn_metaman, qblockman, qsnapman,
                             &mn_activeman, chainman, sporkman, llmq_params, quorums_watch, quorums_idx),
...
void ActiveDKGSessionHandler::WaitForNextPhase(std::optional<QuorumPhase> curPhase,
...
void ActiveDKGSessionHandler::SleepBeforePhase(QuorumPhase curPhase,
                                               const uint256& expectedQuorumHash,
...
void ActiveDKGSessionHandler::HandlePhase(QuorumPhase curPhase,
                                          QuorumPhase nextPhase,
                                          const uint256& expectedQuorumHash,
                                          double randomSleepFactor,

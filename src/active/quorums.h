...
public:
    ...
    [[nodiscard]] MessageProcessingResult ProcessEncryptedContribs(CNode& pfrom, bool request_limit_exceeded,
                                                                   CDataStream& vStream, CQuorum& quorum,
                                                                   CQuorumDataRequest& request,
                                                                   const CBlockIndex* const block_index,
                                                                   std::string_view msg_type) override;

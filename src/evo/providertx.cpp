...
std::string CProRegTx::ToString() const
{
    ...
    return strprintf("CProRegTx(nVersion=%d, nType=%d, collateralOutpoint=%s, addr=%s, nOperatorReward=%f, "
                     ...
                     nVersion, ToUnderlying(nType), collateralOutpoint.ToStringShort(), addr.GetPrimaryService().ToStringAddrPort(),
...
std::string CProUpServTx::ToString() const
{
    ...
    return strprintf("CProUpServTx(nVersion=%d, nType=%d, proTxHash=%s, addr=%s, operatorPayoutAddress=%s, "
                     ...
                     nVersion, ToUnderlying(nType), proTxHash.ToString(), addr.GetPrimaryService().ToStringAddrPort(), payee,

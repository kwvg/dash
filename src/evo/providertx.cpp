...
[[nodiscard]] uint16_t GetMaxFromDeployment(gsl::not_null<const CBlockIndex*> pindexPrev, std::optional<bool> is_basic_override)
{
...
{
    if (nVersion == 0 || nVersion > ProTxVersion::GetMaxFromDeployment(pindexPrev)) {

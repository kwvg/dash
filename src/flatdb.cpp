...
template <typename T>
bool CFlatDB<T>::Store(const T& objToSave)
{
...
template class CFlatDB<NetFulfilledRequestStore>;
template class CFlatDB<SporkStore>;
template class CFlatDB<GovernanceStore>;
template class CFlatDB<MasternodeMetaStore>;

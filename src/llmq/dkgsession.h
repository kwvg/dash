...
class CDKGSession
{
    ...
    friend class dkg::ActiveSession;
...
protected:
    virtual bool MaybeDecrypt(const CBLSIESMultiRecipientObjects<CBLSSecretKey>& obj, size_t idx, CBLSSecretKey& ret_obj, int version) { return false; }

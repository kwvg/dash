...
public:
    CDKGSessionHandler(const Consensus::LLMQParams& _params, CBLSWorker& _blsWorker, CDKGSessionManager& _dkgManager, CConnman& _connman, dash::Context& _ctx, int _quorumIndex) :
            params(_params),
            ...
            curSession(std::make_unique<CDKGSession>(_params, _blsWorker, _dkgManager, _connman, _ctx)),

...
public:
    explicit CInstantSendManager(CTxMemPool& _mempool, CConnman& _connman, llmq::Context& _ctx, bool unitTests, bool fWipe) : db(unitTests, fWipe), mempool(_mempool), connman(_connman), ctx(_ctx) { workInterrupt.reset(); }

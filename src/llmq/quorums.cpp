...
CQuorumManager::CQuorumManager(std::shared_ptr<CEvoDB> _evoDb, CConnman& _connman, CBLSWorker& _blsWorker, CQuorumBlockProcessor& _quorumBlockProcessor,
                               CDKGSessionManager& _dkgManager) :
    connman(_connman),
    m_evoDb(std::move(_evoDb)),

...
public:
    ...
    static bool EnsureQuorumConnections(const Consensus::LLMQParams& llmqParams, const dash::Context& ctx, const CBlockIndex* pQuorumBaseBlockIndex, CConnman& connman, const uint256& myProTxHash);

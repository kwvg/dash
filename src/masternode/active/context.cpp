                                                               ...
                                                               *llmq_ctx.qman, sporkman, mempool, mn_sync)}
{
    qdkgsman->InitializeHandlers([&](const Consensus::LLMQParams& llmq_params,
        ...
        return std::make_unique<llmq::CDKGSessionHandler>(*llmq_ctx.bls_worker, dmnman, *dkgdbgman, *qdkgsman, mn_metaman,
                                                          *llmq_ctx.quorum_block_processor, *llmq_ctx.qsnapman, &mn_activeman,
                                                          chainman, sporkman, llmq_params, quorums_watch, quorum_idx);
    });

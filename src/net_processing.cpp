...
public:
    PeerManagerImpl(const CChainParams& chainparams, CConnman& connman, CAddrMan& addrman,
                    ...
                    CTxMemPool& pool, const std::unique_ptr<CJContext>& cj_ctx, const std::unique_ptr<LLMQContext>& llmq_ctx,
...
std::unique_ptr<PeerManager> PeerManager::make(const CChainParams& chainparams, CConnman& connman, CAddrMan& addrman, BanMan* banman,
                                               ...
                                               bool ignore_incoming_txs)
{
    return std::make_unique<PeerManagerImpl>(chainparams, connman, addrman, banman, scheduler, chainman, pool, cj_ctx, llmq_ctx, ignore_incoming_txs);
}

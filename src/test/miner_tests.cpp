...
BlockAssembler MinerTestingSetup::AssemblerForTest(const CChainParams& params)
{
    ...
    return BlockAssembler(*m_node.mempool, params, options, *m_node.llmq_ctx);
}
...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    // }
    //BOOST_CHECK(pblocktemplate = BlockAssembler(*m_node.mempool, chainparams, *m_node.llmq_ctx).CreateNewBlock(scriptPubKey));

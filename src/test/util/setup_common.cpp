    ...
    : BasicTestingSetup(chainName, extra_args)
{
    ...
    m_node.llmq_ctx = std::make_unique<LLMQContext>(Assert(m_node.chainman)->ActiveChainstate(), *m_node.connman, *m_node.evodb, *m_node.mempool, *sporkManager, m_node.peerman, true, false);

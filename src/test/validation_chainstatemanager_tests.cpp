...
BOOST_AUTO_TEST_CASE(chainstatemanager)
{
    ...
    //
    CChainState& c1 = *WITH_LOCK(::cs_main, return &manager.InitializeChainstate(*m_node.llmq_ctx));
    ...
    //
    CChainState& c2 = *WITH_LOCK(::cs_main, return &manager.InitializeChainstate(*m_node.llmq_ctx, GetRandHash()));

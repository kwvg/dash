...
BOOST_AUTO_TEST_CASE(getcoinscachesizestate)
{
    ...
    CChainState chainstate(&mempool, blockman, *Assert(m_node.chainman), llmq::chainLocksHandler, llmq::quorumInstantSendManager, llmq::quorumBlockProcessor, m_node.evodb);

                                                     ...
                                                     const std::optional<uint256>& snapshot_blockhash)
{
    ...
    to_modify.reset(new CChainState(mempool, m_blockman, clhandler, isman, quorum_block_processor, evoDb, snapshot_blockhash));
        ...
        bool in_memory)
{
    ...
    auto snapshot_chainstate = WITH_LOCK(::cs_main, return std::make_unique<CChainState>(
            /* mempool */ nullptr, m_blockman, this->ActiveChainstate().m_clhandler, this->ActiveChainstate().m_isman,

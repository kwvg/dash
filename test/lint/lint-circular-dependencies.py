...
EXPECTED_CIRCULAR_DEPENDENCIES = (
    ...
    "llmq/chainlocks -> instantsend/instantsend -> llmq/chainlocks",
    "llmq/chainlocks -> instantsend/instantsend -> net_processing -> llmq/chainlocks",
    "llmq/chainlocks -> validation -> llmq/chainlocks",
    "llmq/commitment -> llmq/utils -> llmq/snapshot -> llmq/commitment",
    "llmq/context -> instantsend/instantsend -> net_processing -> llmq/context",
